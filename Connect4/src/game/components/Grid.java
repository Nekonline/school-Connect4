...
import game.GridInsertException;
...
public class Grid {
	...
	// Fill the grid with dot to show it is empty
	...
	// Insert token in the column choose
	...
	// Check if one type of token is lined up in diagonal or in column or in line
